module "rg" {
  source = "git::https://github.com/PrakashNexTurn/terraform-modules.git//azure/resource-group?ref=develop"
...
module "storage" {
  ...
  source = "git::https://github.com/PrakashNexTurn/terraform-modules.git//azure/storage?ref=develop"
...
module "sql" {
  ...
  source = "git::https://github.com/PrakashNexTurn/terraform-modules.git//azure/sql?ref=develop"
